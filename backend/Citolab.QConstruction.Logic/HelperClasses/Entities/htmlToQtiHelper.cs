...
{
    /// <summary>
    ///     Helper to convert html to qti html
    /// </summary>
    public class HtmlToQtiHelper
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="HtmlToQtiHelper" /> class.
        /// </summary>
        /// <history>
        ///     [marcelh] 12-7-2012 Created
        /// </history>
        public HtmlToQtiHelper(IRepositoryFactory repository, string tempPath)
        {
        ...
        /// <summary>
        ///     Converts the HTML style to inline CSS.
        /// </summary>
        ...
        /// <summary>
        ///     Fixes the image tag. The old html editor didn't add the alt attribute on img. In qti the alt attribute is required
        /// </summary>
        /// <param name="doc">The doc.</param>
        /// <history>
        ///     [marcelh] 12-7-2012 Created
        ...
        {
            var newImages = doc.GetImages(itemcode, _repository.GetRepository<Attachment>())?.ToList();
            newImages?.ForEach(i =>
            {
                var name = $"IMG-{i.Key}";
